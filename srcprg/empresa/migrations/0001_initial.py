    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nicho_mercado', models.CharField(choices=[('M', 'Marketing'), ('N', 'Nutrição'), ('D', 'Design')], max_length=3)), # noqa
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nivel_experiencia', models.CharField(choices=[('J', 'Júnior'), ('P', 'Pleno'), ('S', 'Sênior')], max_length=2)), # noqa
                ('data_final', models.DateField()),
                ('status', models.CharField(choices=[('I', 'Interesse'), ('C', 'Currículo enviado'), ('E', 'Entrevista'), ('D', 'Desafio técnico'), ('F', 'Finalizado')], max_length=30)), # noqa
